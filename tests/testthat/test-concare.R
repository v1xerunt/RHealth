...
# Test script to verify that the ConCare model can learn from synthetic data

test_that("ConCare model can learn from pseudo-data with mixed features", {
  ...
  print("ConCare evaluation results:")
  print(result)
