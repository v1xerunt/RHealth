...
This is the first CRAN submission of RHealth, a comprehensive deep learning toolkit for healthcare predictive modeling in R.
...
* Support for multiple input/output schemas (binary, multiclass, multilabel, regression)
...
### Funding
RHealth is funded by the [ISC grant from the R Consortium](https://r-consortium.org/all-projects/2024-group-2.html#deeprhealth-a-deep-learning-toolkit-for-healthcare-predictive-modeling).

### Related Work
RHealth is the R counterpart to the Python library [PyHealth](https://github.com/sunlabuiuc/PyHealth).
